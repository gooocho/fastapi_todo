...
class TestTasks:
    def test_task_find(self, sample_db: Session) -> None:
        task1 = crud_task.find(db=sample_db, task_id=TaskId(id=1))
        assert task1.id == 1


    def test_task_all(self, sample_db: Session) -> None:
        tasks = crud_task.all(db=sample_db, limit=100, offset=0)
        assert len(tasks) == 6


    def test_task_create(self, sample_db: Session) -> None:
    ...
    def test_task_update(self, sample_db: Session) -> None:
    ...
    def test_task_filterd_by_status(self, sample_db: Session) -> None:
    ...
    def test_task_not_assigned(self, sample_db: Session) -> None:
    ...
    def test_task_not_resolved(self, sample_db: Session) -> None:
